...
int main()
{
    ...
    std::vector<Eigen::Matrix4d> transformations = beam.ComputeJointGroupOptimisation(maxIterations, minRelativeTranslationRMSE, 500.0, 1.0, referenceDiameter, "area_ratios.csv");
